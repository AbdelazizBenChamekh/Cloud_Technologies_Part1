...
Самое важное, что мы поняли: 
Нужно смотреть не на названия сервисов, а на их функциональное назначение. Тогда можно создать единую модель для любых провайдеров.
