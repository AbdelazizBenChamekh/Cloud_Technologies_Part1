...
### Личные итоги
Эта лабораторная работа показала нам, что облачные сервисы — это не магия, а логика. За каждым названием в биллинге стоит конкретная услуга с конкретной стоимостью.

Самое важное, что мы поняли: Нужно смотреть не на названия сервисов, а на их функциональное назначение. Тогда можно создать единую модель для любых провайдеров.

Работа выполнена в команде с использованием официальной документации и анализа реальных кейсов компаний.
